		...
		<SidebarContext.Provider value={contextValue}>
			<TooltipProvider delayDuration={0}>
				<div
					...
					className={cn("group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-full w-full", className)}
					{...props}
				>
					{children}
				</div>
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main"> & { sidebarRight?: React.ReactNode }) {
	return (
		<React.Fragment>
			<main
				...
				className={cn(
					...
					IS_DESKTOP
						? "md:peer-data-[variant=inset]:m-6 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-4 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:mb-4 md:peer-data-[variant=inset]:mr-4"
						: "md:peer-data-[variant=inset]:m-4 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-4 md:peer-data-[variant=inset]:ml-0",
